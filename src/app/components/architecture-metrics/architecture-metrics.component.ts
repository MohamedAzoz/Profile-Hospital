...
@Component({
  ...
  template: `
    <section
      id="capabilities"
      *transloco="let t"
      class="py-20 relative overflow-hidden bg-linear-to-b from-transparent via-blue-900/5 to-transparent"
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="text-center max-w-3xl mx-auto space-y-4 flex flex-col items-center mb-16">
          <span
            class="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-700"
          >
            {{ t('capabilities.tag') }}
          </span>
