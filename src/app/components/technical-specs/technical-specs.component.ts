    ...
    <section id="specs" *transloco="let t" class="py-24 relative overflow-hidden">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span class="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-cyan-100 dark:bg-cyan-900/50 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-700">
            {{ t('specs.tag') }}
          </span>
        ...
        <!-- Specs Grid Table -->
        <div class="glass-card rounded-3xl p-8 border border-raw-border shadow-xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
